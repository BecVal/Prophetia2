...
OPTUNA_PARAMS_FILE = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../data/processed/models_best_parameters/optuna_params_gbm_model.json'))  # <-- NUEVA RUTA: models_best_parameters
...
def train_gbm_model():
    ...
    if RUN_OPTUNA:
        logger.info(f"Optimizando Modelo Cuantitativo GBM con Optuna ({OPTUNA_TRIALS} Trials)...")
    ...
    logger.info(f"Mejores parámetros XGBoost GBM: {best_params}")
