...
def build_processed_dataset():
    ...
    logger.info(
        f"Procesando {
            len(matches_df)} partidos para extracción de características avanzadas...")
    ...
    logger.info(
        f"Estructura del dataset final (debe ser 2x los partidos originales): {
            final_df.shape}")
